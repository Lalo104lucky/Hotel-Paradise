...
const UserMobileLayout = () => {
  ...
  const navItems = [
    { id: 'asignar', label: 'Asignar', icon: ClipboardList, path: '/user/mobile' },
    { id: 'escanear', label: 'Escanear', icon: Scan, path: '/user/mobile/escanear' },
    { id: 'habitaciones', label: 'Todas', icon: Building2, path: '/user/mobile/habitaciones' },
    { id: 'alertas', label: 'Alertas', icon: Bell, path: '/user/mobile/alertas' }
  ];
      ...
      <header className="bg-gradient-to-r px-4 py-4 flex items-center justify-between shadow-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-800">{getUserName()} • Camarera</p>
          </div>
        </div>
        <button
          ...
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2.5 text-white rounded-xl font-medium hover:bg-blue-700 transition-colors"
